...
## Write examples for each of these control flows: loop, if-else, for, while, match

Chapter 2, pages 48-52

## Write example for these type of matching (literals, variables, enums, match guards, match ranges, with option, with result)

Chapter 2, pages 52-56

## use uwrape and expect for

Chapter 2, pages 57-59

## write an error for the Result, Err arm and try to destructure the erro
...
## destructure and Err with match and if let, panic in in the case of error and print the destructured error
